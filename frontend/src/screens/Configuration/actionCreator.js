...
export const updateNames=(first_name,last_name,token)=>(dispatch)=>{
	...
	axios.put("http://localhost:8000/api/v1/auth/changeNames",params,config)
	.then((res)=>{
		return dispatch({
...
export const updateUsername=(username,token)=>(dispatch)=>{
	...
	axios.put("http://localhost:8000/api/v1/auth/changeUsername",params,config)
	.then((res)=>{
		return dispatch({
...
export const updateEmail=(email,token)=>(dispatch)=>{
	...
	axios.put("http://localhost:8000/api/v1/auth/changeEmail",params,config)
	.then((res)=>{
		return dispatch({
...
export const updatePassword=(old_password,password,password_confirm,token)=>(dispatch)=>{
	const params={
		old_password,
		password,
		password_confirm
	...
	axios.put("http://localhost:8000/api/v1/auth/changePassword",params,config)
	.then((res)=>{
		return dispatch({
